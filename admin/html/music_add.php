...
<input type="text" name="bg_320x480" placeholder="/m/pix/album_320x480.jpg" value="<?php echo $_POST['bg_320x480']; ?>" size="50" /></p>

<p>iPhone landscape: (link to 480x320 jpg file)<br />
<input type="text" name="bg_480x320" placeholder="/m/pix/album_480x320.jpg" value="<?php echo $_POST['bg_480x320']; ?>" size="50" /></p>

<p>iPad portrait: (link to 768x1024 jpg file)<br />
<input type="text" name="bg_768" placeholder="/m/pix/album_768.jpg" value="<?php echo $_POST['bg_768']; ?>" size="50" /></p>

<p>iPad landscape: (link to 1024x768 jpg file)<br />
<input type="text" name="bg_1024" placeholder="/m/pix/album_1024.jpg" value="<?php echo $_POST['bg_1024']; ?>" size="50" /></p>

<p>Songs: (links to MP3 files, one-per-line)<br />
<textarea name="songs" rows="4" cols="90" placeholder="/m/mp3/song_name.mp3"><?php echo $_POST['songs']; ?></textarea></p>
